...
const MensWearPage = () => {
  ...
  const filterOptions = {
    ...
    priceRange: ['Under LKR 3,000', 'LKR 3,000 - LKR 4,000', 'Over LKR 4,000'],
    size: ['S', 'M', 'L', 'XL', 'XXL'],
    ...
    if (filters.priceRange.length > 0) {
      result = result.filter(product => {
        return filters.priceRange.some(range => {
          ...
          if (range === 'LKR 3,000 - LKR 4,000' && product.price >= 3000 && product.price <= 4000) return true;
          if (range === 'Over LKR 4,000' && product.price > 4000) return true;
          return false;
        });
      });
    }
