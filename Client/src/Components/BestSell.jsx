    ...
    <div className="max-w-full mx-auto px-20 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        {products.map((product) => (
          ...
          >
            <div className="relative overflow-hidden rounded-2xl bg-gray-100 mb-4 group">
              {product.isNew && (
              ...
              <img 
                src={product.image} 
                alt={product.name}
                className="w-full h-[33rem] object-cover group-hover:scale-105 transition-transform duration-300"
              />
              
              {/* Dark Overlay and View Item Button */}
              <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all duration-300 flex items-center justify-center">
                <button className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-white text-black px-8 py-3 rounded-full font-bold text-sm hover:bg-gray-100">
                  View Item
                </button>
              </div>
            </div>
      ...
      <div className="flex justify-left mt-12">
        <button className="bg-black text-white px-10 py-3 rounded-lg font-bold text-lg hover:bg-gray-800 transition-colors flex items-center gap-2">
          View Collection
